...
namespace LunaEditor.GameProject
{
    ...
    public class OpenExistProject
    {
        private static readonly string _applicationDataPath = $@"{Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData)}\LunaEditor\";
        ...
        private static void ReadProjectData()
        {
            if(File.Exists(_projectDataPath))
            {
                ...
                foreach(var project in projects)
                {
                    ...
                    {
                        project.Icon = File.ReadAllBytes($@"{project.ProjectPath}\.Luna\Icon.png");
                        project.Screenshot = File.ReadAllBytes($@"{project.ProjectPath}\.Luna\Screenshot.png");
